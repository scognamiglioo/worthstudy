...
import 'package:worthstudy/presenter/pages/components/stopwatch_buttom_component.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
      child: Observer(builder: (_) {
        ...
        return Container(
          color: store.working() ? Colors.red : Colors.lightGreen,
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Text(
                store.working() ? 'Momento de estudo' : 'Pausa para descanso',
