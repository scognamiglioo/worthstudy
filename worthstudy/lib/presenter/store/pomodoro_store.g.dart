...
mixin _$PomodoroStore on _PomodoroStore, Store {
  get _$_startedAtom => Atom(name: '_PomodoroStore._started',);
  ...
  late final _$_minutesAtom =
      Atom(name: '_PomodoroStore._minutes');
  ...
  late final _$_secondsAtom =
      Atom(name: '_PomodoroStore._seconds');
  ...
  late final _$_timeWorkAtom =
      Atom(name: '_PomodoroStore._timeWork');
  ...
  late final _$_timeRestAtom =
      Atom(name: '_PomodoroStore._timeRest');
  ...
  late final _$breakTypeAtom =
      Atom(name: '_PomodoroStore.breakType');
